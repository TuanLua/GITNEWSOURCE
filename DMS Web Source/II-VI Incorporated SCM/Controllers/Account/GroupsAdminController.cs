...
namespace II_VI_Incorporated_SCM.Controllers.Account
{
    ...
    public class GroupsAdminController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.RolesList = 
                this.RoleManager.Roles.OrderBy(r => r.Group).ToList();
            return View();
        }
        ...
        public async Task<ActionResult> Create(
            [Bind(Include = "Name,Description")] GroupViewModel GroupViewModel, params string[] selectedRoles)
        {
            if (ModelState.IsValid)
            {
                // Create the new Group:
                var applicationgroup = new ApplicationGroup(GroupViewModel.Name, GroupViewModel.Description);
        ...
        public async Task<ActionResult> Edit(string id)
        {
            ...
            {
                var listItem = new RoleViewModel()
                {
                    Group = Role.Group,
                    Name = Role.Name,
                    Id = Role.Id,
